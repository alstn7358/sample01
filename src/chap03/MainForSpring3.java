...
import chap03.AlreadyExistingMemberException;
...
public class MainForSpring3 {
	...
	public static void main(String[] args) throws IOException {
		...
		String[] conf = {"classpath:chap03/conf1.xml","classpath:chap03/xml/conf2.xml"};
		
		ctx = new GenericXmlApplicationContext("classpath:chap03/xml/appCtx3.xml");
